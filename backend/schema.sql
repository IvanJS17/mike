...
-- ============================================================================
-- LiTT sync S5: scoped memory (ported from upstream 20260910_06/07).
-- Appended section; the claim_db_* functions above are the leak-safe variant.
-- ============================================================================
...
alter table public.user_profiles
  ...
  add column if not exists project_memory_default boolean not null default false;
...
begin
  ...
  insert into public.memory_files(scope, user_id, enabled)
  select distinct 'user', pending.actor_user_id, false
