...
export function UserMemoryPage() {
    ...
    const saveMemory = useCallback(
        (content: string, revision: number) =>
            updateUserMemory(content, revision),
        [],
    );
    const {
        memory,
        ...
        <div className="space-y-8">
            ...
            >
                <h2
                    ...
                    className="text-2xl font-medium font-serif text-gray-900"
                >
                    Memory
                </h2>
                ...
                <SettingsSection>
                    {loading ? (
                        ...
                        <SettingsRow>
                            <div className="space-y-1">
                                ...
                                <p className="text-sm text-red-600" role="alert">
                                    Could not load memory settings. Please try
                                    again.
                                </p>
                            </div>
                            <PillButton
                        ...
                        <SettingsRow>
                            <div className="space-y-1">
                                <FieldLabel as="p">App-wide memory</FieldLabel>
                                <p className="text-sm text-gray-500">
                                    Let Mike curate useful details after saved
                                    conversations and use them in future
                                    answers.
                                </p>
                            </div>
...
function ProjectMemoryDefaultRow() {
    ...
    return (
        <SettingsRow>
            <div className="space-y-1">
                <FieldLabel as="p">
                    Project memory for new projects
                </FieldLabel>
                <p className="text-sm text-gray-500">
                    Choose whether memory is enabled by default for projects you
                    create. Project owners can still change it for each project.
                </p>
                {error ? (
            ...
            <ToggleSwitch
                checked={profile?.projectMemoryDefault === true}
